...
namespace WebApi.Controllers
{
    ...
    public class ColourController : ControllerBase
    {
        ...
        [HttpPost("GetColors")]
        public async Task<IActionResult> Get(string teamName, IFormFile imageFile, string provider = "gemini")
        {
            try
            {
                byte[] imageBytes;
                ...
                if (colourModel == null)
                {
                    return BadRequest($"A resposta não pôde ser convertida para ColoursModel para  {teamName}.");
                }
